  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="flex gap-2 mb-6 flex-wrap">
        ...
        <Link
          to="/addresses"
          className="flex items-center gap-2 bg-white border border-gray-200 px-5 py-2
    rounded-full text-gray-600 hover:border-purple-400 hover:text-purple-600 transition font-medium"
        >
          📍 Manage Addresses
        </Link>
      </div>
